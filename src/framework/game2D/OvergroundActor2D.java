...
import template.shooting.Player;
 ...
 * 
 */
public abstract class OvergroundActor2D extends Actor2D {
	...
	public void setDirection(double dir) {
		Vector3d dirV = new Vector3d(0.0, 0.0,dir);
		super.setDirection(dirV);
	}
	...
	public void setVelocity(double vx, double vy) {
		Velocity2D vel = new Velocity2D(vx, vy);
	...
	public boolean doesScerenOut(int w, int h) {
